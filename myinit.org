...
- [[#vanilla-emacs-settings][vanilla emacs settings]]
  ...
  - [[#some-constants-and-settings-that-need-to-be-configured-initially][some constants and settings that need to be configured initially]]
    - [[#constants][constants]]
    - [[#custom-file-settings][custom-file settings]]
...
- [[#psudo-native-i-prefer-to-install-these-using-the-systems-package-manager][psudo native (i prefer to install these using the system's package manager)]]
  - [[#pdf-tools][pdf-tools]]
...
(defmacro my/use-package (name &rest args)
  "My custom use-package macro that ensures t if pdf-tools-install command exists."
  `(use-package ,name
