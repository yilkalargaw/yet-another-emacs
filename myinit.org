...
(use-package ivy
  ...
  ;; full file names - useful when multiple files have same names (oneof '(full name abbreviate))
  ...
  (setq dashboard-navigator-buttons
        `(;; line1
          ((,(all-the-icons-octicon "mark-github" :height 1.1 :v-adjust 0.0)
            "Source"
            "Source Page"
            (lambda (&rest _) (browse-web "https://github.com/yilkalargaw/yet-another-emacs")))
           (,(all-the-icons-octicon "gear" :height 1.1 :v-adjust 0.0)
            "Config"
            "Config File"
            (lambda (&rest _) (let ((upath (expand-file-name "myinit.org" user-emacs-directory)))
                                (find-file upath))))
           (,(all-the-icons-icon-for-dir "Home" :height 1.1 :v-adjust 0.0)
            "Files"
            "Browse Files"
            (lambda (&rest _) (find-file "~")))
           (,(all-the-icons-octicon "package" :height 1.1 :v-adjust 0.0)
            "Packages"
            "Browse Packages"
...
(use-package all-the-icons-ivy-rich
   :ensure t
   :defer t
   :hook (ivy-mode . (lambda () (all-the-icons-ivy-rich-mode 1))))
