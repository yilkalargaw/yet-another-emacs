...
(setq package-list
    '(
      ...
      rainbow-delimiters all-the-icons dired-sidebar company-c-headers irony company-irony
      ...
      lsp-ui dap-mode emojify writeroom-mode spray org-pdfview origami peep-dired
      dired-quick-sort interleave rg
      
      ox-gfm org-bullets org-tree-slide epresent ox-pandoc ox-twbs
      ox-epub org-beautify-theme moe-theme abyss-theme
...
(use-package hydra
  ...
  (add-hook 'origami-mode-hook (lambda () (define-key prog-mode-map (kbd "φ o") 'hydra-folding/body)))
  (add-hook 'ibuffer-mode-hook (lambda () (define-key ibuffer-mode-map (kbd "φ .") 'hydra-ibuffer-main/body)))
  (add-hook 'dired-mode-hook (lambda () (define-key dired-mode-map (kbd "φ .") 'hydra-dired/body)))
  (add-hook 'projectile-mode-hook (lambda () (define-key projectile-mode-map (kbd "φ p") 'hydra-projectile/body))))
...
(use-package emojify
  ...
  :bind (("H-e e" . emojify-mode)
	 (:map emojify-mode
	       ("H-e i" . emojify-insert-emoji)
	       ("H-e d" . emojify-describe-emoji)
	       ("H-e l" . emojify-list-emojis)))
;; :init (add-hook 'after-init-hook #'global-emojify-mode)
 :config (lambda () (global-emojify-mode))
 )
