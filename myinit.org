...
(use-package ecb
  ...
  :bind (( "C-c e b" . ecb-minor-mode)
         :map ecb-mode-map
         ("γ 1" . 'ecb-goto-window-edit1)
         ("γ 2" . 'ecb-goto-window-directories)
         ("γ 3" . 'ecb-goto-window-sources)
         ("γ 4" . 'ecb-goto-window-methods)
         ("γ 5" . 'ecb-goto-window-history)))
...
(use-package org-beautify :defer t :ensure t)
