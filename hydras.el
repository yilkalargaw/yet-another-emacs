...
;; (define-key hydra-map (kbd "z b") 'hydra-buffer-zoom/body)
;; (define-key hydra-map (kbd "z g") 'hydra-global-zoom/body)
(define-key hydra-map (kbd "m") 'hydra-multiple-cursors/body)
(define-key hydra-map (kbd "a") 'hydra-avy/body)
(define-key hydra-map (kbd "n") 'hydra-move/body)
(define-key hydra-map (kbd "r") 'hydra-rectangle/body)
